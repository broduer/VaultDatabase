            ...
            <div class="col-md-6" align="center" style="background-color:#DEE2E6; border-radius:10px; padding:10px;">
               ...
               <form action="?" method="get">
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control" id="playername" name="search" placeholder="Enter your query here.">
                  </div>
                  ...
                  <div class="accordion" id="accordion">
                     <div class="card">
                        <div class="card-header" id="headingFour">
                           <h2 class="mb-0">
                              <button type="button" class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseStats">General</button>
                           </h2>
                        </div>
                        <div id="collapseStats" class="collapse show" aria-labelledby="headingStats" data-parent="#accordion">
                           <div class="card-body">
                              <?php
                              ...
                              <h4>Last Seen: </h4>
                              <p><?php echo $ls_date->format("M jS Y h:ia") ?> (<?php echo secondsToTime($ls_since) ?> ago)</p>
                              <h4>Playtime: </h4>
                     ...
                     <div class="card">
                        <div class="card-header" id="headingOne">
                           <h2 class="mb-0">
                              <button type="button" class="btn btn-link" data-toggle="collapse" data-target="#collapsePunish">Punishments</button>
                           </h2>
                        </div>
                        <div id="collapsePunish" class="collapse" aria-labelledby="headingPunish" data-parent="#accordion">
                           <div class="card-body">
                              <h4>Bans</h4>
                              <table class="table table-bordered table-hover">
                                 <thead>
                     ...
                     <div class="card">
                        <div class="card-header" id="headingTwo">
                           <h2 class="mb-0">
                              <button type="button" class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseClans">Clans</button>
                           </h2>
                        </div>
                        <div id="collapseClans" class="collapse" aria-labelledby="headingClans" data-parent="#accordion">
                           <div class="card-body">
                              <?php
                                 // get the records from the database
                                 if ($result = $mysqli_c->query("SELECT clan, rank FROM playerClans WHERE player = '$full_uuid'")) {
                                     ...
                                     if ($result->num_rows > 0) {
                                         $row = $result->fetch_object();
                                             ?>
                              <h4>Clan:</h4>
                              <p><a href="../?clan=<?php echo htmlspecialchars($row->clan)?>"><?php echo htmlspecialchars($row->clan)?></a></p>
                              <h4>Rank: </h4>
                              <p><?php echo ucfirst($row->rank) ?></p>
                              <?php
                                 } else { ?>
            ...
            <div class="col-md-6">
               <div class="row" style="background-color:#DEE2E6; border-radius:10px; padding:10px;">
                  ...
                  <div class="col-md-6">
                     ...
                     <p>This custom interface helps you to view information about players on VaultMC. VaultClans plugin by yangyang200, VaultCore plugin & WebUI by Aberdeener.</p>
                  </div>
               </div>
            </div>
            <div class="col-md-3">
